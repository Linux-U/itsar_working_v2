...
assaydata <- data.matrix(proteinGroups[,32:42]) 
...
#phenotable <- matrix(c("C","D","C","D","C","D","C","D","C","D","D"))
phenotable <- matrix(c("C","D","C","C","D","C","D","D","C","D","D"))
...
featuretable <- proteinGroups[c(1:31,43:69)]
...
expdiff <- as.matrix(rowMeans(norm_edata[,c(2,5,7,8,10,11)])-rowMeans(norm_edata[,c(1,3,4,6,9)]))
...
proteinGroups[,c(32:42)] <- norm_edata[,1:11]
